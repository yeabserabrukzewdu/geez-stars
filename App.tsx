  ...
  return (
    <div className="space-y-0 w-full overflow-hidden">
      ...
      <section className="py-20 md:py-32 bg-black relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-yellow-500/[0.02] blur-[100px] md:blur-[150px] rounded-full pointer-events-none"></div>
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-24 items-center">
            <div className="reveal-left">
              <span className="text-yellow-500 font-black tracking-[0.5em] uppercase mb-6 block text-[10px]">Behind The Lens</span>
              <h2 className="text-4xl sm:text-5xl md:text-[7rem] font-black mb-8 md:mb-12 uppercase tracking-tighter leading-[0.8]">
                THE <span className="gradient-text">STARS</span> <br/> 
                BEHIND <br/> 
                THE GEEZ.
              </h2>
              <div className="max-w-lg">
                <p className="text-gray-400 text-lg md:text-2xl leading-relaxed font-light mb-10 italic border-l-4 border-yellow-500/30 pl-6 md:pl-8">
                ...
                <a href="#about" className="inline-block px-10 py-4 md:px-12 md:py-5 bg-white/5 border border-white/10 rounded-full font-black text-[9px] md:text-[10px] uppercase tracking-[0.4em] hover:bg-yellow-500 hover:text-black transition-all duration-500 group">
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-8 reveal-right">
              ...
              <div className="aspect-[9/16] rounded-[2rem] md:rounded-[3rem] overflow-hidden relative group shadow-2xl mt-8 md:mt-20">
                <img 
                  src="/home 2.webp" 
      ...
      <section className="relative min-h-[70vh] md:min-h-[80vh] bg-black overflow-hidden py-20 md:py-32">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 md:mb-24 gap-10 md:gap-12">
            <div className="max-w-2xl reveal-left">
              <span className="text-yellow-500 font-black tracking-[0.5em] uppercase mb-6 md:mb-8 block text-[10px]">Our Specialization</span>
              <h2 className="text-5xl sm:text-6xl md:text-9xl font-black mb-6 md:mb-10 uppercase tracking-tighter leading-[0.8]">
              ...
              <p className="text-gray-400 text-lg md:text-2xl leading-relaxed max-w-xl font-light reveal" style={{ transitionDelay: '0.2s' }}>
            ...
            <div className="reveal-right hidden md:block">
              <a href="#services" className="group flex flex-col items-center space-y-6 text-yellow-500 font-black tracking-widest uppercase text-xs">
                <div className="w-20 h-20 md:w-24 md:h-24 rounded-full border border-yellow-500/30 flex items-center justify-center group-hover:bg-yellow-500 group-hover:text-black transition-all duration-700 transform group-hover:rotate-180 group-hover:scale-110">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 reveal-stagger">
            {[
              ...
              <div key={idx} className="glass p-8 md:p-16 rounded-[2rem] md:rounded-[4rem] border border-white/5 hover:border-yellow-500/20 transition-all duration-700 group perspective-card">
                <div className="w-14 h-14 md:w-20 md:h-20 bg-yellow-500/10 border border-yellow-500/20 rounded-[1.2rem] md:rounded-[1.5rem] flex items-center justify-center text-yellow-500 font-black text-xl md:text-2xl mb-6 md:mb-12 shadow-[0_0_40px_rgba(234,179,8,0.1)] group-hover:bg-yellow-500 group-hover:text-black transition-all duration-700">
                  {item.id}
                </div>
                <h3 className="text-xl md:text-3xl font-black mb-4 md:mb-6 text-white uppercase tracking-tighter">{item.title}</h3>
                <p className="text-gray-500 text-sm md:text-lg leading-relaxed group-hover:text-gray-300 transition-colors">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="bg-black space-y-20 md:space-y-32">
        <section className="container mx-auto px-6 py-20 md:py-32">
          <div className="text-center mb-16 md:mb-24 reveal">
            <h2 className="text-5xl sm:text-6xl md:text-[10rem] font-black mb-6 md:mb-8 uppercase tracking-tighter leading-none">
              <span className="text-mask"><span>LATEST</span></span> <br/>
              <span className="text-mask"><span className="gradient-text">IMPACT</span></span>
            </h2>
            <p className="text-gray-500 text-xs md:text-lg font-medium tracking-[0.4em] uppercase">The Art of Visual Storytelling.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20">
            {latestImpact.map((item, idx) => (
              <div key={idx} className={`group relative aspect-[16/10] rounded-[2rem] md:rounded-[5rem] overflow-hidden shadow-2xl transition-all duration-1000 ${idx % 2 === 0 ? 'reveal-left' : 'reveal-right'}`}>
                 ...
                 <div className="absolute bottom-6 left-6 right-6 md:bottom-16 md:left-16 md:right-16 flex justify-between items-end opacity-0 group-hover:opacity-100 translate-y-10 group-hover:translate-y-0 transition-all duration-700">
                   <div>
                     <h3 className="text-xl sm:text-2xl md:text-5xl font-black text-white mb-2 md:mb-4 uppercase tracking-tighter">{item.title}</h3>
                     <span className="bg-white/10 backdrop-blur-md text-white border border-white/20 px-4 py-1.5 md:px-8 md:py-3 rounded-full font-black text-[8px] md:text-[10px] uppercase tracking-[0.4em]">{item.tag}</span>
                   </div>
                   <div className="w-10 h-10 md:w-16 md:h-16 bg-yellow-500 rounded-full flex items-center justify-center text-black text-lg md:text-2xl font-black shadow-2xl">↗</div>
                 </div>
              </div>
            ))}
          </div>
...
const AboutPage = () => (
  <div className="page-enter bg-black w-full overflow-hidden">
    ...
    <section className="py-20 md:py-32 container mx-auto px-6">
      <div className="max-w-6xl mx-auto">
        <div className="reveal-left mb-16 md:mb-24">
           <span className="text-yellow-500 font-black tracking-[0.5em] uppercase mb-6 md:mb-8 block text-[10px]">The Manifesto</span>
           <h2 className="text-5xl sm:text-6xl md:text-9xl font-black mb-10 md:mb-16 uppercase tracking-tighter leading-[0.8]">ARCHITECTS <br/>OF <span className="gradient-text">MOTION.</span></h2>
        </div>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-32 items-center">
          <div className="reveal">
            <p className="text-gray-400 text-lg md:text-3xl leading-relaxed font-light italic border-l-8 border-yellow-500 pl-6 md:pl-12 mb-10 md:mb-12">
              {aboutContent.manifesto}
            </p>
            <div className="flex items-center space-x-6">
               <div className="w-12 md:w-20 h-px bg-yellow-500"></div>
               <span className="text-white font-black tracking-widest uppercase text-[10px] md:text-xs">Since 2018</span>
            </div>
          </div>
          <div className="reveal-right relative">
             <div className="aspect-[4/5] rounded-[2rem] md:rounded-[4rem] overflow-hidden shadow-2xl group">
             ...
             <div className="absolute -bottom-4 -left-4 md:-bottom-10 md:-left-10 glass p-6 md:p-10 rounded-[1.5rem] md:rounded-[3rem] animate-float">
                <span className="text-3xl md:text-5xl font-black gradient-text">7+</span>
                <p className="text-[8px] md:text-[10px] font-black text-gray-500 uppercase tracking-widest mt-2">Years of Excellence</p>
             </div>
          </div>
        </div>
      </div>
    ...
    <section className="relative py-24 md:py-48 bg-[#050505] overflow-hidden">
       <div className="absolute top-0 right-0 w-full h-full opacity-20 pointer-events-none">
          <div className="absolute top-0 right-0 w-[400px] md:w-[800px] h-[400px] md:h-[800px] bg-purple-500/10 blur-[100px] md:blur-[150px] rounded-full"></div>
          <div className="absolute bottom-0 left-0 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-yellow-500/5 blur-[80px] md:blur-[120px] rounded-full"></div>
       </div>

       <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-24">
             <div className="reveal-left group">
                <div className="relative aspect-video rounded-[1.5rem] md:rounded-[4rem] overflow-hidden mb-8 md:mb-12 border border-white/10 group-hover:border-purple-500/30 transition-all duration-700 shadow-2xl">
                   ...
                   <div className="absolute top-4 left-4 md:top-10 md:left-10">
                      <span className="px-5 py-1.5 md:px-8 md:py-3 bg-white/10 backdrop-blur-md rounded-full border border-white/20 text-white font-black text-[8px] md:text-[10px] uppercase tracking-widest">FUTURE FOCUS</span>
                   </div>
                </div>
                <h3 className="text-3xl md:text-7xl font-black mb-4 md:mb-8 text-white uppercase tracking-tighter">{aboutContent.vision.title}</h3>
                <p className="text-gray-500 text-base md:text-xl leading-relaxed max-w-xl group-hover:text-gray-300 transition-colors">
                   {aboutContent.vision.description}
                </p>
             </div>

             <div className="reveal-right group lg:mt-32">
                <div className="relative aspect-video rounded-[1.5rem] md:rounded-[4rem] overflow-hidden mb-8 md:mb-12 border border-white/10 group-hover:border-yellow-500/30 transition-all duration-700 shadow-2xl">
                   ...
                   <div className="absolute inset-0 bg-black/40 group-hover:bg-transparent transition-all"></div>
                   <div className="absolute top-4 left-4 md:top-10 md:left-10">
                      <span className="px-5 py-1.5 md:px-8 md:py-3 bg-yellow-500 rounded-full text-black font-black text-[8px] md:text-[10px] uppercase tracking-widest">ACTIVE IMPACT</span>
                   </div>
                </div>
                <h3 className="text-3xl md:text-7xl font-black mb-4 md:mb-8 text-white uppercase tracking-tighter">{aboutContent.mission.title}</h3>
                <p className="text-gray-500 text-base md:text-xl leading-relaxed max-w-xl group-hover:text-gray-300 transition-colors">
...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-[#000000] min-h-screen text-gray-200 selection:bg-yellow-500/40 relative w-full overflow-x-hidden">
      <div className="fixed top-0 left-0 w-full h-1 z-[1000] overflow-hidden pointer-events-none">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[10%] left-[5%] w-[40%] md:w-[60%] h-[40%] md:h-[60%] bg-yellow-500/[0.03] rounded-full blur-[100px] md:blur-[200px] animate-float"></div>
        <div className="absolute bottom-[10%] right-[5%] w-[30%] md:w-[50%] h-[30%] md:h-[50%] bg-orange-500/[0.02] rounded-full blur-[100px] md:blur-[200px] animate-float" style={{ animationDelay: '4s' }}></div>
      </div>

      <div className="relative z-10 w-full">
        <Header />
        <main key={currentPath} className="w-full">
          {renderContent()}
        </main>
        <Footer />
        <ChatWidget />
