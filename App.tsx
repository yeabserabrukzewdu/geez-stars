...
const HomePage = () => {
  return (
    <div className="space-y-0">
      ...
      {/* GEEZ STARS GLIMPSE - NEW SECTION */}
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="reveal-left">
              ...
              <h2 className="text-6xl md:text-[7rem] font-black mb-12 uppercase tracking-tighter leading-[0.8]">
            ...
            <div className="grid grid-cols-2 gap-8 reveal-right">
              {/* TikTok Ratio Image 1 */}
              <div className="aspect-[9/16] rounded-[3rem] overflow-hidden relative group shadow-2xl">
                <img 
                  src="https://res.cloudinary.com/dlfdjcuat/image/upload/v1770287973/IMG_20241115_172301_820_yfpizj.jpg" 
              ...
              {/* TikTok Ratio Image 2 - Offset for visual interest */}
              <div className="aspect-[9/16] rounded-[3rem] overflow-hidden relative group shadow-2xl mt-20">
                <img 
                  src="https://res.cloudinary.com/dlfdjcuat/image/upload/v1770289309/IMG_20260117_231911_356_mxjwcl.webp" 
                  className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 scale-110 group-hover:scale-100" 
                  alt="Team Glimpse 2" 
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-80 group-hover:opacity-40 transition-opacity"></div>
        ...
        <div className="container mx-auto px-6 relative z-10 py-48">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 reveal-stagger">
            {[
              ...
              <div key={idx} className="glass p-16 rounded-[4rem] border border-white/5 hover:border-yellow-500/20 transition-all duration-700 group perspective-card">
                <div className="w-20 h-20 bg-yellow-500/10 border border-yellow-500/20 rounded-[1.5rem] flex items-center justify-center text-yellow-500 font-black text-2xl mb-12 shadow-[0_0_40px_rgba(234,179,8,0.1)] group-hover:bg-yellow-500 group-hover:text-black transition-all duration-700">
                  {item.id}
                </div>
                <h3 className="text-3xl font-black mb-6 text-white uppercase tracking-tighter">{item.title}</h3>
      ...
      <div className="bg-black pt-32 space-y-64">
        <section className="container mx-auto px-6">
          <div className="text-center mb-32 reveal">
            <h2 className="text-7xl md:text-[10rem] font-black mb-10 uppercase tracking-tighter leading-none">
              <span className="text-mask"><span>LATEST</span></span> <br/>
              <span className="text-mask"><span className="gradient-text">IMPACT</span></span>
            </h2>
            <p className="text-gray-500 text-lg font-medium tracking-[0.4em] uppercase">The Art of Visual Storytelling.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
            {latestImpact.map((item, idx) => (
              <div key={idx} className={`group relative aspect-[16/10] rounded-[5rem] overflow-hidden shadow-2xl transition-all duration-1000 ${idx % 2 === 0 ? 'reveal-left' : 'reveal-right'}`}>
                 ...
                 <div className="absolute bottom-16 left-16 right-16 flex justify-between items-end opacity-0 group-hover:opacity-100 translate-y-10 group-hover:translate-y-0 transition-all duration-700">
                   <div>
                     <h3 className="text-5xl font-black text-white mb-4 uppercase tracking-tighter">{item.title}</h3>
                     <span className="bg-white/10 backdrop-blur-md text-white border border-white/20 px-8 py-3 rounded-full font-black text-[10px] uppercase tracking-[0.4em]">{item.tag}</span>
                   </div>
                   <div className="w-16 h-16 bg-yellow-500 rounded-full flex items-center justify-center text-black text-2xl font-black shadow-2xl">↗</div>
                 </div>
              </div>
            ))}
          </div>
  ...
  <div className="page-enter bg-black">
    ...
    <section className="py-48 container mx-auto px-6">
      <div className="max-w-6xl mx-auto">
        <div className="reveal-left mb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
          <div className="reveal">
            <p className="text-gray-400 text-2xl md:text-3xl leading-relaxed font-light italic border-l-8 border-yellow-500 pl-12 mb-12">
          ...
          <div className="reveal-right relative">
             <div className="aspect-[4/5] rounded-[4rem] overflow-hidden shadow-2xl group">
                <img src="https://res.cloudinary.com/dlfdjcuat/image/upload/v1770287983/IMG_20250526_013443_361_suypho.jpg" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-[5s]" alt="Geez Studio" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>
             </div>
             <div className="absolute -bottom-10 -left-10 glass p-10 rounded-[3rem] animate-float">
                <span className="text-5xl font-black gradient-text">6+</span>
                <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest mt-2">Years of Excellence</p>
             </div>
          </div>
        </div>
      </div>
    ...
    {/* Vision & Mission - Vivid Section */}
    <section className="relative py-64 bg-[#050505] overflow-hidden">
       ...
       <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
             ...
             <div className="reveal-left group">
                <div className="relative aspect-video rounded-[4rem] overflow-hidden mb-12 border border-white/10 group-hover:border-purple-500/30 transition-all duration-700 shadow-2xl">
                   ...
                   <div className="absolute top-10 left-10">
                      <span className="px-8 py-3 bg-white/10 backdrop-blur-md rounded-full border border-white/20 text-white font-black text-[10px] uppercase tracking-widest">FUTURE FOCUS</span>
                   </div>
                </div>
                <h3 className="text-5xl md:text-7xl font-black mb-8 text-white uppercase tracking-tighter">{aboutContent.vision.title}</h3>
                <p className="text-gray-500 text-xl leading-relaxed max-w-xl group-hover:text-gray-300 transition-colors">
             ...
             <div className="reveal-right group lg:mt-32">
                <div className="relative aspect-video rounded-[4rem] overflow-hidden mb-12 border border-white/10 group-hover:border-yellow-500/30 transition-all duration-700 shadow-2xl">
                   ...
                   <div className="absolute inset-0 bg-black/40 group-hover:bg-transparent transition-all"></div>
                   <div className="absolute top-10 left-10">
                      <span className="px-8 py-3 bg-yellow-500 rounded-full text-black font-black text-[10px] uppercase tracking-widest">ACTIVE IMPACT</span>
                   </div>
                </div>
                <h3 className="text-5xl md:text-7xl font-black mb-8 text-white uppercase tracking-tighter">{aboutContent.mission.title}</h3>
                <p className="text-gray-500 text-xl leading-relaxed max-w-xl group-hover:text-gray-300 transition-colors">
    ...
    <section className="py-48 bg-black">
       <div className="container mx-auto px-6">
          <div className="text-center mb-32 reveal">
             ...
             <p className="text-gray-500 text-xl font-light">Our uncompromising principles in digital craft.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 reveal-stagger">
             {aboutContent.philosophy.map((item, idx) => (
                <div key={idx} className="glass p-16 rounded-[4rem] border border-white/5 hover:border-yellow-500/20 transition-all duration-700 group perspective-card">
                   <div className="text-yellow-500 text-4xl font-black mb-8 opacity-50 group-hover:opacity-100 group-hover:scale-110 origin-left transition-all">0{idx+1}</div>
                   <h4 className="text-3xl font-black text-white mb-6 uppercase tracking-tight">{item.title}</h4>
    ...
    <section className="py-48 bg-black">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-32">
          <div className="reveal-left">
            <h1 className="text-8xl md:text-[11rem] font-black mb-20 uppercase leading-[0.8] tracking-tighter">IGNITE <br/>YOUR <br/><span className="gradient-text">BRAND.</span></h1>
            <div className="space-y-20 reveal-stagger">
              <div className="flex items-center space-x-12 group">
                <div className="w-28 h-28 glass rounded-[3rem] flex items-center justify-center text-5xl group-hover:scale-110 transition-all duration-700">📍</div>
                <div>
                  <h4 className="font-black text-white text-3xl uppercase tracking-widest mb-2">HQ Studio</h4>
                  <p className="text-gray-500 text-xl">Bole KKare, Addis Ababa</p>
                </div>
              </div>
              <div className="flex items-center space-x-12 group">
                <div className="w-28 h-28 glass rounded-[3rem] flex items-center justify-center text-5xl group-hover:scale-110 group-hover:rotate-12 transition-all duration-700">⚡</div>
                <div>
                  <h4 className="font-black text-white text-3xl uppercase tracking-widest mb-2">Direct</h4>
                  <p className="text-yellow-500 font-black text-4xl tracking-tighter">+251 92 298 1639</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="reveal-right">
            <div className="glass p-20 rounded-[6rem] border border-white/5 shadow-[0_50px_100px_rgba(0,0,0,0.5)]">
              <form className="space-y-12" onSubmit={(e) => e.preventDefault()}>
                <div className="space-y-6">
                  <label className="text-[10px] font-black uppercase tracking-[0.4em] text-gray-500 ml-6">Full Name</label>
                  <input type="text" placeholder="Your Name" className="w-full bg-white/5 border border-white/10 p-10 rounded-[3rem] text-white outline-none focus:border-yellow-500 focus:bg-white/10 transition-all text-xl" />
                </div>
                <div className="space-y-6">
                  <label className="text-[10px] font-black uppercase tracking-[0.4em] text-gray-500 ml-6">Email Address</label>
                  <input type="email" placeholder="hello@brand.com" className="w-full bg-white/5 border border-white/10 p-10 rounded-[3rem] text-white outline-none focus:border-yellow-500 focus:bg-white/10 transition-all text-xl" />
                </div>
                <div className="space-y-6">
                  <label className="text-[10px] font-black uppercase tracking-[0.4em] text-gray-500 ml-6">The Brief</label>
                  <textarea placeholder="Describe your cinematic vision..." rows={4} className="w-full bg-white/5 border border-white/10 p-10 rounded-[3rem] text-white outline-none focus:border-yellow-500 focus:bg-white/10 transition-all text-xl"></textarea>
                </div>
                <button className="w-full py-10 bg-yellow-500 text-black font-black rounded-[3rem] hover:scale-105 transition-all uppercase tracking-[0.4em] text-xl shadow-2xl shadow-yellow-500/20">
                  Ignite Now
                </button>
              </form>
            </div>
